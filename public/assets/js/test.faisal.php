...
<!--                                <img src="--><!--/images/video-status-icon.png">-->
                        <object type="application/x-shockwave-flash" width="100%" height="330" id="externalInterface" data="https://www.hapity.com/assets/js/web-back-alt.swf" name="externalInterface">
